...
const Skills = () => {
    return (
        ...
        sm:bg-circularLightSm sm:dark:bg-circularDarkSm'>
            ...
            <Skill name="Analytical Thinking" x="-25vw" y="2vw" />
            <Skill name="Python" x="0vw" y="14vw" />
            <Skill name="Statistics" x="-20vw" y="-15vw" />
            ...
            <Skill name="HTML/CSS" x="21vw" y="3vw" />
            <Skill name="Scrum" x="18vw" y="18vw" />
