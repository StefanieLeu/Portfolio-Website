...
const NavBar = () => {
    ...
    return (
        ...
        border-b-2 border-dark dark:border-light first-letter
        dark:bg-primaryDunkel bg-primaryHell
        position: fixed 
 ...
 <nav>
            ...
            <nav className="flex items-center justify-center flex-wrap"> 
                ...
                <motion.a href="https://github.com/StefanieLeu" target={"_blank"}
                whileHover={{y:-2 }}
                whileTap={{scale:0.9}}
                className="w-6 mx-2"
                >
                ...
                <motion.a href="https://www.linkedin.com/in/leutenegger-s/" target={"_blank"}
                whileHover={{y:-2 }}
                whileTap={{scale:0.9}}
                className="w-6 mx-2"
                >
            ...
            <button 
                ...
                className={`w-8 h-8 ml-2 flex items-center justify-center rounded-full p-1
...

{
    ...
    className='
    min-w-[70vw] flex flex-col justify-between z-30 items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 
    ...
    <nav className='flex items-center flex-col justify-center'>
               ...
               <button 
                   onClick={() => setMode(mode === "light" ? "dark" : "light")}
                   className={`w-6 h-6 ml-3 flex border border-solid items-center justify-center rounded-full p-1
